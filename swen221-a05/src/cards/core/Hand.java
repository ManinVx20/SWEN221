...
/**
 * Represents a hand of cards held by a player. As the current round proceeds, the number of cards in the hand will decrease. When the round is over, new cards will be delt and added to this hand.
 * 
